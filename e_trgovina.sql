...
CREATE TABLE proizvodi (
    ...
    kolicina_na_skladistu INT NOT NULL CHECK (kolicina_na_skladistu >= 0),
    slika VARCHAR(255),
    specifikacije TEXT,
    datum_kreiranja TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (kategorija_id) REFERENCES kategorije_proizvoda(id)
);
...
CREATE TABLE popusti (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proizvod_id INT NOT NULL,
    postotak_popusta DECIMAL(5, 2) NOT NULL CHECK (postotak_popusta BETWEEN 0 AND 100),
    datum_pocetka DATE NOT NULL,
    datum_zavrsetka DATE NOT NULL,
    FOREIGN KEY (proizvod_id) REFERENCES proizvodi(id)
);
...
(367, 'Notepad++', 'Besplatan tekstualni editor.', 0.0, 14, 95, 'notepad++.jpg', 'Editor za kodiranje', '2023-01-20'),
...
(377, 'Microsoft Teams', 'Softver za timsku suradnju.', 0.0, 14, 195, 'microsoft_teams.jpg', 'Timska suradnja', '2023-01-30'),
...
(497, 'DJI Mavic Air 2', 'Dron s naprednim kamerama za visokokvalitetne snimke.', 7500, 20, 10, 'dji_mavic_air_2.jpg', 'Kamera: 48MP, Domet: 10km, Trajanje leta: 34 min.', '2024-11-16'),        
(498, 'DJI Mini 3 Pro', 'Lagani i kompaktni dron s moćnim performansama.', 5700, 20, 15, 'dji_mini_3_pro.jpg', 'Kamera: 4K, Domet: 12km, Trajanje leta: 31 min.', '2024-11-16'),
(499, 'Autel EVO Lite+', 'Dron s 1-inčnim senzorom kamere za profesionalne snimke.', 8700, 20, 8, 'autel_evo_lite_plus.jpg', 'Kamera: 20MP, Domet: 15km, Trajanje leta: 40 min.', '2024-11-16'),
(500, 'DJI FPV Combo', 'Brzi dron s FPV iskustvom.', 9500, 20, 6, 'dji_fpv_combo.jpg', 'Kamera: 4K, Maksimalna brzina: 140 km/h, Trajanje leta: 20 min.', '2024-11-16'),
(501, 'Parrot Anafi', 'Praktični dron za putovanja.', 4200, 20, 20, 'parrot_anafi.jpg', 'Kamera: 21MP, Domet: 4km, Trajanje leta: 25 min.', '2024-11-16'),
(502, 'Holy Stone HS720E', 'Pristupačni dron s naprednim značajkama.', 3200, 20, 25, 'holy_stone_hs720e.jpg', 'Kamera: 4K, GPS sustav, Trajanje leta: 23 min.', '2024-11-16'),
(503, 'DJI Inspire 2', 'Profesionalni dron za snimatelje.', 25000, 20, 3, 'dji_inspire_2.jpg', 'Kamera: 5.2K, Domet: 7km, Trajanje leta: 27 min.', '2024-11-16'),
(504, 'Ryze Tello', 'Mini dron za početnike i zabavu.', 1000, 20, 50, 'ryze_tello.jpg', 'Kamera: 5MP, Domet: 100m, Trajanje leta: 13 min.', '2024-11-16'),
(505, 'DJI Phantom 4 Pro', 'Robustan dron s naprednim senzorima.', 11000, 20, 7, 'dji_phantom_4_pro.jpg', 'Kamera: 20MP, Domet: 8km, Trajanje leta: 30 min.', '2024-11-16'),
(506, 'FIMI X8 Mini', 'Kompaktni dron s odličnim značajkama.', 3600, 20, 18, 'fimi_x8_mini.jpg', 'Kamera: 4K, Domet: 8km, Trajanje leta: 31 min.', '2024-11-16'),
(507, 'DJI Air 2S', 'Napredni dron s 1-inčnim senzorom.', 8200, 20, 12, 'dji_air_2s.jpg', 'Kamera: 20MP, Domet: 12km, Trajanje leta: 31 min.', '2024-11-16'),
(508, 'Hubsan Zino Mini Pro', 'Dron s inteligentnim funkcijama.', 5400, 20, 15, 'hubsan_zino_mini_pro.jpg', 'Kamera: 4K, Domet: 10km, Trajanje leta: 40 min.', '2024-11-16'),
(509, 'Parrot Bebop 2', 'Jednostavan dron za rekreativne korisnike.', 3000, 20, 20, 'parrot_bebop_2.jpg', 'Kamera: 14MP, Domet: 2km, Trajanje leta: 25 min.', '2024-11-16'),
(510, 'Autel Robotics EVO II', 'Moćni dron s 8K kamerom.', 13500, 20, 5, 'autel_evo_ii.jpg', 'Kamera: 48MP, Domet: 9km, Trajanje leta: 40 min.', '2024-11-16'),
(511, 'DJI Mini SE', 'Povoljni dron za osnovne korisnike.', 2600, 20, 22, 'dji_mini_se.jpg', 'Kamera: 2.7K, Domet: 4km, Trajanje leta: 30 min.', '2024-11-16'),
(512, 'PowerVision PowerEgg X', 'Višenamjenski dron i kamera.', 7800, 20, 10, 'powervision_poweregg_x.jpg', 'Kamera: 4K, Vodootporan, Trajanje leta: 30 min.', '2024-11-16'),
(513, 'Walkera Vitus 320', 'Prijenosni dron s odličnim kamerama.', 6800, 20, 8, 'walkera_vitus_320.jpg', 'Kamera: 12MP, Domet: 5km, Trajanje leta: 25 min.', '2024-11-16'),
(514, 'Snaptain SP500', 'Pristupačan dron s GPS sustavom.', 2200, 20, 30, 'snaptain_sp500.jpg', 'Kamera: 1080p, Domet: 1.5km, Trajanje leta: 15 min.', '2024-11-16'),
(515, 'Yuneec Typhoon H', 'Dron s 360° rotirajućom kamerom.', 10500, 20, 5, 'yuneec_typhoon_h.jpg', 'Kamera: 4K, Domet: 1.6km, Trajanje leta: 25 min.', '2024-11-16'),
(516, 'Parrot Disco', 'FPV dron s jedinstvenim dizajnom.', 6200, 20, 12, 'parrot_disco.jpg', 'Kamera: 14MP, Domet: 2km, Trajanje leta: 45 min.', '2024-11-16'),
(517, 'DJI Mavic 3', 'Dron s dvostrukom kamerom i vrhunskim značajkama.', 14500, 20, 4, 'dji_mavic_3.jpg', 'Kamera: 20MP + 12MP, Domet: 15km, Trajanje leta: 46 min.', '2024-11-16'),
(518, 'Potensic T25', 'Pristupačni dron za početnike.', 1600, 20, 30, 'potensic_t25.jpg', 'Kamera: 1080p, GPS sustav, Trajanje leta: 10 min.', '2024-11-16'),
(519, 'Skydio 2+', 'Autonomni dron s naprednom AI tehnologijom.', 9500, 20, 8, 'skydio_2_plus.jpg', 'Kamera: 4K, Domet: 6km, Trajanje leta: 27 min.', '2024-11-16'),
(520, 'EACHINE E58', 'Mini dron za rekreativnu zabavu.', 900, 20, 40, 'eachine_e58.jpg', 'Kamera: 720p, Domet: 80m, Trajanje leta: 9 min.', '2024-11-16'),
(521, 'DJI Phantom SE', 'Pouzdani dron s moćnom kamerom.', 9600, 20, 6, 'dji_phantom_se.jpg', 'Kamera: 4K, Domet: 5km, Trajanje leta: 25 min.', '2024-11-16'),
(522, 'Ruko F11 Pro', 'Dron s GPS sustavom i dugačkim dometom.', 3600, 20, 18, 'ruko_f11_pro.jpg', 'Kamera: 4K, Domet: 1.2km, Trajanje leta: 30 min.', '2024-11-16'),
(523, 'Autel EVO Nano+', 'Lagani dron s naprednim značajkama.', 5200, 20, 15, 'autel_evo_nano_plus.jpg', 'Kamera: 50MP, Domet: 10km, Trajanje leta: 28 min.', '2024-11-16'),
(524, 'MJX Bugs 12 EIS', 'Dron srednje klase s GPS sustavom.', 2500, 20, 20, 'mjx_bugs_12_eis.jpg', 'Kamera: 4K, Domet: 800m, Trajanje leta: 22 min.', '2024-11-16'),
(525, 'Parrot Swing', 'FPV dron s jedinstvenim X-oblikom.', 1800, 20, 30, 'parrot_swing.jpg', 'Kamera: 720p, Domet: 300m, Trajanje leta: 8 min.', '2024-11-16'),
(526, 'Canon LaserJet 1200', 'Laserski printer visokih performansi.', 2000, 13, 15, 'canon_laserjet_1200.jpg', 'Rezolucija: 1200 dpi, Brzina ispisa: 20 stranica/min.', '2024-11-16'),
(527, 'HP Inkjet 2710', 'Kompaktni inkjet printer s Wi-Fi povezivanjem.', 850, 13, 10, 'hp_inkjet_2710.jpg', 'Rezolucija: 4800 dpi, Brzina ispisa: 10 stranica/min.', '2024-11-16'),
(528, 'Epson EcoTank L3150', 'Printer s visokokapacitetnim spremnikom tinte.', 1200, 13, 8, 'epson_ecotank_l3150.jpg', 'Kapacitet: 6500 stranica, Brzina ispisa: 15 stranica/min.', '2024-11-16'),(529, 'Brother HL-L2350DW', 'Kompaktni monokromatski laserski printer.', 1200, 13, 20, 'brother_hl_l2350dw.jpg', 'Rezolucija: 2400 x 600 dpi, Brzina ispisa: 30 stranica/min.', '2024-11-16'),    
(530, 'Canon PIXMA G3410', 'Višenamjenski printer s Wi-Fi funkcijom.', 1400, 13, 15, 'canon_pixma_g3410.jpg', 'Rezolucija: 4800 x 1200 dpi, Brzina ispisa: 8 stranica/min.', '2024-11-16'),       
(531, 'HP DeskJet Plus 4120', 'Povoljni printer s mobilnim ispisom.', 850, 13, 25, 'hp_deskjet_plus_4120.jpg', 'Rezolucija: 4800 x 1200 dpi, Brzina ispisa: 7.5 stranica/min.', '2024-11-16'),    
(532, 'Epson WorkForce WF-2830', 'Multifunkcijski printer s obostranim ispisom.', 1100, 13, 10, 'epson_workforce_wf2830.jpg', 'Rezolucija: 5760 x 1440 dpi, Brzina ispisa: 10 stranica/min.', '2024-11-16'),
(533, 'Samsung Xpress M2020W', 'Brzi laserski printer za uredsku upotrebu.', 1350, 13, 8, 'samsung_xpress_m2020w.jpg', 'Rezolucija: 1200 x 1200 dpi, Brzina ispisa: 21 stranica/min.', '2024-11-16'),
(534, 'Canon i-SENSYS MF643Cdw', 'Višenamjenski laserski printer u boji.', 2300, 13, 5, 'canon_isensys_mf643cdw.jpg', 'Rezolucija: 1200 dpi, Brzina ispisa: 21 stranica/min.', '2024-11-16'),     
(535, 'Brother DCP-L3550CDW', 'Multifunkcijski printer s Wi-Fi funkcijom.', 2500, 13, 12, 'brother_dcp_l3550cdw.jpg', 'Rezolucija: 2400 dpi, Brzina ispisa: 18 stranica/min.', '2024-11-16'),     
(536, 'Epson EcoTank L850', 'Printer s funkcijom ispisa fotografija.', 4000, 13, 7, 'epson_ecotank_l850.jpg', 'Rezolucija: 5760 x 1440 dpi, Foto ispis.', '2024-11-16'),
(537, 'HP LaserJet Pro MFP M428fdw', 'Višenamjenski printer s brzim ispisom.', 3200, 13, 6, 'hp_laserjet_pro_mfp_m428fdw.jpg', 'Rezolucija: 1200 dpi, Brzina ispisa: 38 stranica/min.', '2024-11-16'),
(538, 'Canon PIXMA TR4550', 'Povoljni printer za kućnu upotrebu.', 700, 13, 20, 'canon_pixma_tr4550.jpg', 'Rezolucija: 4800 dpi, Brzina ispisa: 8 stranica/min.', '2024-11-16'),
(539, 'Brother MFC-L3750CDW', 'Multifunkcijski laserski printer u boji.', 2700, 13, 10, 'brother_mfc_l3750cdw.jpg', 'Rezolucija: 2400 dpi, Brzina ispisa: 19 stranica/min.', '2024-11-16'),       
(540, 'Epson Expression Home XP-3100', 'Višenamjenski kompaktni printer.', 950, 13, 15, 'epson_expression_home_xp3100.jpg', 'Rezolucija: 5760 dpi, Brzina ispisa: 10 stranica/min.', '2024-11-16'),
(541, 'HP ENVY Photo 7134', 'Printer za visokokvalitetne fotografije.', 2000, 13, 8, 'hp_envy_photo_7134.jpg', 'Rezolucija: 4800 dpi, Foto ispis.', '2024-11-16'),
(542, 'Canon MAXIFY GX7050', 'Printer visokog kapaciteta za poslovne potrebe.', 4500, 13, 3, 'canon_maxify_gx7050.jpg', 'Rezolucija: 1200 dpi, Kapacitet: 9000 stranica.', '2024-11-16'),
(543, 'Brother HL-L2375DW', 'Brzi monokromatski laserski printer.', 1400, 13, 18, 'brother_hl_l2375dw.jpg', 'Rezolucija: 2400 dpi, Brzina ispisa: 34 stranica/min.', '2024-11-16'),
(544, 'Epson SureColor SC-P700', 'Profesionalni foto printer.', 5500, 13, 2, 'epson_surecolor_scp700.jpg', 'Rezolucija: 5760 dpi, Foto ispis.', '2024-11-16'),
(545, 'HP OfficeJet Pro 9015e', 'Printer za mala poduzeća.', 1800, 13, 10, 'hp_officejet_pro_9015e.jpg', 'Rezolucija: 4800 dpi, Brzina ispisa: 24 stranica/min.', '2024-11-16'),
(546, 'Canon PIXMA G6050', 'Printer s visokim kapacitetom tinte.', 3000, 13, 5, 'canon_pixma_g6050.jpg', 'Kapacitet: 18000 stranica, Rezolucija: 4800 dpi.', '2024-11-16'),
(547, 'Brother DCP-1623WE', 'Jednostavan laserski printer za kućnu upotrebu.', 1200, 13, 25, 'brother_dcp_1623we.jpg', 'Rezolucija: 2400 dpi, Brzina ispisa: 20 stranica/min.', '2024-11-16'),    
(548, 'Epson EcoTank L5190', 'Multifunkcijski printer s funkcijom faksa.', 2800, 13, 12, 'epson_ecotank_l5190.jpg', 'Rezolucija: 5760 dpi, Kapacitet tinte: 6500 stranica.', '2024-11-16'),
(549, 'HP LaserJet Pro M15w', 'Najmanji laserski printer na tržištu.', 750, 13, 20, 'hp_laserjet_pro_m15w.jpg', 'Rezolucija: 600 dpi, Brzina ispisa: 19 stranica/min.', '2024-11-16'),
(550, 'Canon i-SENSYS MF3010', 'Kompaktan i povoljan laserski printer.', 1200, 13, 15, 'canon_isensys_mf3010.jpg', 'Rezolucija: 600 dpi, Brzina ispisa: 18 stranica/min.', '2024-11-16'),
(551, 'Epson Stylus Photo R3000', 'Profesionalni printer za velike formate.', 6500, 13, 3, 'epson_stylus_photo_r3000.jpg', 'Rezolucija: 5760 dpi, Format: A3.', '2024-11-16'),
(552, 'Brother HL-L8260CDW', 'Laserski printer u boji za uredske korisnike.', 3500, 13, 7, 'brother_hl_l8260cdw.jpg', 'Rezolucija: 2400 dpi, Brzina ispisa: 31 stranica/min.', '2024-11-16'),     
(553, 'Canon PIXMA iP8750', 'Printer za ispis fotografija u velikim formatima.', 4500, 13, 4, 'canon_pixma_ip8750.jpg', 'Rezolucija: 9600 dpi, Foto ispis.', '2024-11-16'),
(554, 'HP DeskJet 2720e', 'Jednostavan printer za svakodnevne zadatke.', 600, 13, 30, 'hp_deskjet_2720e.jpg', 'Rezolucija: 4800 dpi, Brzina ispisa: 7.5 stranica/min.', '2024-11-16'),
(555, 'Apple iPad Air 10.9', 'Tanak i lagan tablet s A14 Bionic čipom.', 5400, 19, 20, 'ipad_air_10.9.jpg', 'Ekran: 10.9", Čip: A14 Bionic, Pohrana: 64GB.', '2024-11-16'),
(556, 'Samsung Galaxy Tab S8', 'Premium Android tablet sa Snapdragon procesorom.', 7300, 19, 15, 'galaxy_tab_s8.jpg', 'Ekran: 11", Procesor: Snapdragon 8 Gen 1, Pohrana: 128GB.', '2024-11-16'), 
(557, 'Lenovo Tab P11 Pro', 'Tablet s OLED ekranom i odličnom baterijom.', 4900, 19, 12, 'lenovo_tab_p11_pro.jpg', 'Ekran: 11.5" OLED, RAM: 6GB, Pohrana: 128GB.', '2024-11-16'),
(558, 'Xiaomi Pad 6', 'Snažan tablet za rad i zabavu.', 3500, 19, 25, 'xiaomi_pad_6.jpg', 'Ekran: 11", Procesor: Snapdragon 870, Pohrana: 128GB.', '2024-11-16'),
(559, 'Microsoft Surface Pro 9', '2-u-1 uređaj za profesionalne korisnike.', 9600, 19, 5, 'surface_pro_9.jpg', 'Ekran: 13", Procesor: Intel i5, RAM: 8GB, Pohrana: 256GB.', '2024-11-16'),        
(560, 'Huawei MatePad 11', 'Android tablet s HarmonyOS sustavom.', 4200, 19, 10, 'huawei_matepad_11.jpg', 'Ekran: 11", Procesor: Snapdragon 865, Pohrana: 128GB.', '2024-11-16'),
(561, 'Apple iPad Mini 6', 'Kompaktni tablet s A15 Bionic čipom.', 5200, 19, 15, 'ipad_mini_6.jpg', 'Ekran: 8.3", Pohrana: 64GB.', '2024-11-16'),
(562, 'Samsung Galaxy Tab A8', 'Pristupačan tablet za osnovne potrebe.', 1700, 19, 30, 'galaxy_tab_a8.jpg', 'Ekran: 10.5", Procesor: Unisoc T618, Pohrana: 32GB.', '2024-11-16'),
(563, 'Lenovo Yoga Tab 13', 'Tablet s ugrađenim stalkom.', 6400, 19, 8, 'lenovo_yoga_tab_13.jpg', 'Ekran: 13", Procesor: Snapdragon 870, RAM: 8GB.', '2024-11-16'),
(564, 'Xiaomi Redmi Pad', 'Odličan omjer cijene i kvalitete.', 2800, 19, 25, 'redmi_pad.jpg', 'Ekran: 10.6", Procesor: MediaTek Helio G99, Pohrana: 128GB.', '2024-11-16'),
(565, 'Microsoft Surface Go 3', 'Kompaktan uređaj za posao i školu.', 4500, 19, 18, 'surface_go_3.jpg', 'Ekran: 10.5", Procesor: Intel Pentium, Pohrana: 64GB.', '2024-11-16'),
(566, 'Apple iPad Pro 12.9', 'Najmoćniji tablet na tržištu.', 12200, 19, 4, 'ipad_pro_12.9.jpg', 'Ekran: 12.9", Čip: M2, Pohrana: 128GB.', '2024-11-16'),
(567, 'Samsung Galaxy Tab S7 FE', 'Tablet srednje klase s velikim ekranom.', 4800, 19, 12, 'galaxy_tab_s7_fe.jpg', 'Ekran: 12.4", Procesor: Snapdragon 750G, Pohrana: 64GB.', '2024-11-16'),      
(568, 'Lenovo Tab M10 HD', 'Osnovni tablet za kućnu upotrebu.', 1400, 19, 30, 'lenovo_tab_m10_hd.jpg', 'Ekran: 10.1", Procesor: MediaTek Helio P22T, Pohrana: 32GB.', '2024-11-16'),
(569, 'Xiaomi Pad 5', 'Tablet s moćnim performansama.', 3800, 19, 10, 'xiaomi_pad_5.jpg', 'Ekran: 11", Procesor: Snapdragon 860, Pohrana: 128GB.', '2024-11-16'),
(570, 'Apple iPad 10th Gen', 'iPad s USB-C povezivanjem.', 5000, 19, 20, 'ipad_10th_gen.jpg', 'Ekran: 10.9", Pohrana: 64GB.', '2024-11-16'),
(571, 'Samsung Galaxy Tab Active3', 'Izdržljiv tablet za terenske korisnike.', 5500, 19, 8, 'galaxy_tab_active3.jpg', 'Ekran: 8", Procesor: Exynos 9810, Pohrana: 64GB.', '2024-11-16'),
(572, 'Huawei MatePad Pro', 'Premium tablet s vrhunskim ekranom.', 7600, 19, 6, 'matepad_pro.jpg', 'Ekran: 12.6" OLED, Procesor: Kirin 9000E.', '2024-11-16'),
(573, 'Lenovo Tab P11', 'Tablet s dugim trajanjem baterije.', 2900, 19, 22, 'lenovo_tab_p11.jpg', 'Ekran: 11", RAM: 4GB, Pohrana: 64GB.', '2024-11-16'),
(574, 'Samsung Galaxy Tab S6 Lite', 'Tablet s olovkom za bilješke.', 3400, 19, 15, 'galaxy_tab_s6_lite.jpg', 'Ekran: 10.4", Procesor: Exynos 9611, Pohrana: 64GB.', '2024-11-16'),
(575, 'Xiaomi Mi Pad 5 Pro', 'Tablet s moćnim performansama za zabavu.', 5000, 19, 18, 'mi_pad_5_pro.jpg', 'Ekran: 11", Procesor: Snapdragon 870, Pohrana: 128GB.', '2024-11-16'),
(576, 'Apple iPad 9th Gen', 'Osnovni model iPada za svakodnevnu upotrebu.', 3700, 19, 25, 'ipad_9th_gen.jpg', 'Ekran: 10.2", Pohrana: 64GB.', '2024-11-16'),
(577, 'Samsung Galaxy Tab S8 Ultra', 'Najveći i najsnažniji Galaxy tablet.', 9700, 19, 3, 'galaxy_tab_s8_ultra.jpg', 'Ekran: 14.6", Procesor: Snapdragon 8 Gen 1, Pohrana: 256GB.', '2024-11-16'),(578, 'Lenovo Tab M8 HD', 'Kompaktan i povoljan tablet.', 1200, 19, 35, 'lenovo_tab_m8_hd.jpg', 'Ekran: 8", Procesor: MediaTek A22, Pohrana: 32GB.', '2024-11-16'),
(579, 'Samsung Galaxy Tab S6', 'Tablet s vrhunskom olovkom.', 6800, 19, 8, 'galaxy_tab_s6.jpg', 'Ekran: 10.5", Procesor: Snapdragon 855, Pohrana: 128GB.', '2024-11-16'),
(580, 'Apple iPad Pro 11', 'Tablet s M2 čipom za profesionalce.', 11500, 19, 4, 'ipad_pro_11.jpg', 'Ekran: 11", Pohrana: 128GB.', '2024-11-16'),
(581, 'Huawei MediaPad T5', 'Osnovni tablet za zabavu i rad.', 1800, 19, 28, 'mediapad_t5.jpg', 'Ekran: 10.1", Procesor: Kirin 659, Pohrana: 32GB.', '2024-11-16'),
(582, 'Microsoft Surface Duo 2', 'Dvostruki ekran za produktivnost.', 14500, 19, 2, 'surface_duo_2.jpg', 'Ekran: 8.3", Procesor: Snapdragon 888.', '2024-11-16'),
(583, 'Sony Alpha a7 III', 'Mirrorless fotoaparat s naprednim senzorom.', 15000, 21, 10, 'sony_alpha_a7_iii.jpg', 'Senzor: 24.2 MP, Video: 4K, Stabilizacija: Da.', '2024-11-16'),
(584, 'Canon EOS R5', 'Profesionalni fotoaparat za fotografiju i video.', 29000, 21, 5, 'canon_eos_r5.jpg', 'Senzor: 45 MP, Video: 8K, Stabilizacija: Da.', '2024-11-16'),
(585, 'Nikon Z6 II', 'Svestrani mirrorless fotoaparat.', 18000, 21, 8, 'nikon_z6_ii.jpg', 'Senzor: 24.5 MP, Video: 4K UHD, Autofokus: Da.', '2024-11-16'),
(586, 'GoPro HERO11 Black', 'Akcijska kamera za ekstremne uvjete.', 3200, 21, 20, 'gopro_hero11_black.jpg', 'Rezolucija: 5.3K, Vodootporna: Do 10m, Stabilizacija: HyperSmooth.', '2024-11-16'),  
(587, 'DJI Osmo Action 3', 'Akcijska kamera s vrhunskim funkcijama.', 2700, 21, 15, 'dji_osmo_action_3.jpg', 'Rezolucija: 4K HDR, Vodootporna: Da, FOV: 155°.', '2024-11-16'),
(588, 'Fujifilm X-T4', 'Mirrorless kamera za kreativne korisnike.', 13500, 21, 6, 'fujifilm_xt4.jpg', 'Senzor: 26 MP, Video: 4K, Stabilizacija: IBIS.', '2024-11-16'),
(589, 'Panasonic Lumix GH6', 'Profesionalna kamera za video produkciju.', 17000, 21, 4, 'panasonic_lumix_gh6.jpg', 'Senzor: 25 MP, Video: 5.7K, Mikrofon: Da.', '2024-11-16'),
(590, 'Olympus OM-D E-M1 Mark III', 'Lagana kamera za profesionalce.', 14000, 21, 7, 'olympus_omd_em1_mark_iii.jpg', 'Senzor: 20 MP, Stabilizacija: Da, Brzina: 60 fps.', '2024-11-16'),
(591, 'Canon PowerShot G7 X Mark III', 'Kompaktna kamera s odličnim performansama.', 5500, 21, 12, 'canon_powershot_g7x.jpg', 'Senzor: 20.1 MP, Video: 4K, Stabilizacija: Da.', '2024-11-16'),    
(592, 'Sony ZV-1', 'Kamera za vloggere.', 6500, 21, 10, 'sony_zv1.jpg', 'Senzor: 20.1 MP, Video: 4K, Mikrofon: Ug. mikrofon.', '2024-11-16'),
(593, 'Insta360 ONE RS', 'Modularna akcijska kamera.', 3500, 21, 15, 'insta360_one_rs.jpg', 'Rezolucija: 5.7K, Vodootporna: Da, 360° video: Da.', '2024-11-16'),
(594, 'Leica Q2', 'Premium kompaktni fotoaparat.', 46000, 21, 2, 'leica_q2.jpg', 'Senzor: 47.3 MP, Objektiv: 28mm, Stabilizacija: Da.', '2024-11-16'),
(595, 'Ricoh GR III', 'Kompaktna kamera s visokim performansama.', 7000, 21, 10, 'ricoh_gr_iii.jpg', 'Senzor: 24 MP, Video: Full HD, Stabilizacija: Da.', '2024-11-16'),
(596, 'Sony FX3', 'Kompaktna cinema kamera za profesionalce.', 29000, 21, 3, 'sony_fx3.jpg', 'Senzor: 10.2 MP, Video: 4K, Dinamički raspon: 15+ stopa.', '2024-11-16'),
(597, 'DJI Pocket 2', 'Kompaktna ručna kamera.', 3800, 21, 12, 'dji_pocket_2.jpg', 'Rezolucija: 4K, Stabilizacija: Gimbal, Zvuk: Stereo.', '2024-11-16'),
(598, 'Blackmagic Pocket Cinema Camera 6K', 'Cinema kamera za video produkciju.', 22000, 21, 4, 'blackmagic_6k.jpg', 'Senzor: 6K, Video: RAW, Dinamički raspon: 13 stopa.', '2024-11-16'),        
(599, 'Canon EOS M50 Mark II', 'Povoljna mirrorless kamera.', 7000, 21, 12, 'canon_eos_m50_mk2.jpg', 'Senzor: 24 MP, Video: 4K, Autofokus: Dual Pixel.', '2024-11-16'),
(600, 'Panasonic Lumix S5', 'Mirrorless kamera s odličnim performansama.', 12500, 21, 5, 'panasonic_lumix_s5.jpg', 'Senzor: 24 MP, Video: 4K 60fps, Stabilizacija: Da.', '2024-11-16'),
(601, 'Sony Alpha ZV-E10', 'Mirrorless kamera za vlogere.', 8500, 21, 10, 'sony_alpha_zve10.jpg', 'Senzor: 24.2 MP, Video: 4K, Mikrofon: Ug. mikrofon.', '2024-11-16'),
(602, 'Nikon Coolpix P1000', 'Superzoom kamera.', 12000, 21, 8, 'nikon_coolpix_p1000.jpg', 'Zoom: 125x, Rezolucija: 16 MP, Video: 4K.', '2024-11-16'),
(603, 'Leica M10-R', 'Napredna digitalna kamera.', 25000, 21, 3, 'leica_m10r.jpg', 'Senzor: 40 MP, Objektiv: 35mm, Stabilizacija: Ne.', '2024-11-16'),
(604, 'Sigma fp L', 'Kompaktna kamera s punim formatom.', 17000, 21, 7, 'sigma_fp_l.jpg', 'Senzor: 61 MP, Video: 4K, RAW: Da.', '2024-11-16'),
(605, 'Panasonic Lumix G85', 'Kamera s 4K video mogućnostima.', 8500, 21, 18, 'panasonic_lumix_g85.jpg', 'Senzor: 16 MP, Video: 4K, Stabilizacija: IBIS.', '2024-11-16'),
(606, 'Fujifilm X100V', 'Kompaktna kamera za ljubitelje fotografije.', 13000, 21, 10, 'fujifilm_x100v.jpg', 'Senzor: 26 MP, Objektiv: 23mm, Stabilizacija: Da.', '2024-11-16'),
(607, 'Nikon D850', 'Profesionalna DSLR kamera.', 27000, 21, 6, 'nikon_d850.jpg', 'Senzor: 45.7 MP, Video: 4K UHD, Autofokus: 153 točke.', '2024-11-16'),
(608, 'Sony RX100 VII', 'Kompaktna kamera s odličnim performansama.', 9500, 21, 14, 'sony_rx100vii.jpg', 'Senzor: 20.1 MP, Video: 4K, Stabilizacija: Da.', '2024-11-16'),
(609, 'Bose QuietComfort 35 II', 'Bežične slušalice s aktivnim poništavanjem buke.', 1700, 22, 12, 'bose_qc35_ii.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 20h.', '2024-11-16'),   
(610, 'Sony WH-1000XM5', 'Bežične slušalice s najboljim poništavanjem buke.', 2000, 22, 8, 'sony_wh1000xm5.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 30h.', '2024-11-16'),
(611, 'Sennheiser Momentum 3', 'Bežične slušalice s visokom kvalitetom zvuka.', 2200, 22, 10, 'sennheiser_momentum_3.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 17h.', '2024-11-16'),
(612, 'JBL Quantum 800', 'Gaming slušalice s bežičnom vezom i surround zvukom.', 1500, 22, 14, 'jbl_quantum_800.jpg', 'Bluetooth: Da, Surround: Da, Autonomija: 14h.', '2024-11-16'),
(613, 'Bose SoundLink Revolve+', 'Bežični zvučnik s 360° zvukom.', 2200, 22, 12, 'bose_soundlink_revolve_plus.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 16h.', '2024-11-16'),
(614, 'Sonos One', 'Pametan zvučnik s integriranim Amazon Alexa.', 2000, 22, 10, 'sonos_one.jpg', 'Wi-Fi: Da, Alexa: Da, Autonomija: Neograničena (s mrežom).', '2024-11-16'),
(615, 'Marshall Stanmore II', 'Snažan zvučnik s retro dizajnom.', 2500, 22, 6, 'marshall_stanmore_ii.jpg', 'Bluetooth: Da, Kablovski ulaz: Da, Autonomija: Neograničena (s mrežom).', '2024-11-16'),
(616, 'Sony SRS-XB43', 'Zvučnik s EXTRA BASS tehnologijom.', 1700, 22, 15, 'sony_srs_xb43.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 24h.', '2024-11-16'),
(617, 'JBL Flip 5', 'Komaktni bežični zvučnik s odličnim zvukom.', 900, 22, 20, 'jbl_flip_5.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 12h.', '2024-11-16'),
(618, 'Anker Soundcore Liberty Air 2 Pro', 'Bežične slušalice s ANC i odličnim zvukom.', 1300, 22, 18, 'anker_soundcore_liberty_air_2_pro.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 8h.', '2024-11-16'),
(619, 'Bose SoundSport Free', 'Sportske bežične slušalice s vrhunskim zvukom.', 1500, 22, 22, 'bose_soundsport_free.jpg', 'Bluetooth: Da, Vodootporne: Da, Autonomija: 5h.', '2024-11-16'),       
(620, 'Audio-Technica ATH-M50x', 'Profesionalne slušalice za studijsko korištenje.', 1700, 22, 10, 'audio_technica_ath_m50x.jpg', 'Kabelske: Da, Zatvoreni tip: Da, Frekvencijski raspon: 15-28,000 Hz.', '2024-11-16'),
(621, 'Beats Studio3 Wireless', 'Bežične slušalice s Active Noise Cancelling (ANC).', 2300, 22, 13, 'beats_studio3_wireless.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 22h.', '2024-11-16'),
(622, 'JBL PartyBox 300', 'Bežični zvučnik za zabave.', 8000, 22, 4, 'jbl_partybox_300.jpg', 'Bluetooth: Da, LED svjetla: Da, Autonomija: 18h.', '2024-11-16'),
(623, 'Logitech G Pro X Wireless', 'Gaming slušalice s bežičnom vezom i Blue Voice tehnologijom.', 1800, 22, 7, 'logitech_g_pro_x_wireless.jpg', 'Bluetooth: Da, Surround: Da, Autonomija: 20h.', '2024-11-16'),
(624, 'Sennheiser HD 660S', 'Open-back slušalice za audiophile zvuk.', 3500, 22, 3, 'sennheiser_hd_660s.jpg', 'Kabelske: Da, Frekvencijski raspon: 10-41,000 Hz, Impedancija: 150 ohma.', '2024-11-16'),
(625, 'Sony HT-Z9F Soundbar', 'Soundbar s Dolby Atmos tehnologijom.', 3500, 22, 5, 'sony_ht_z9f.jpg', 'Wi-Fi: Da, Dolby Atmos: Da, Autonomija: Neograničena (s mrežom).', '2024-11-16'),
(626, 'Bose 700', 'Bežične slušalice s vrhunskim poništavanjem buke.', 2500, 22, 10, 'bose_700.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 20h.', '2024-11-16'),
(627, 'JBL Charge 4', 'Bežični zvučnik s dugotrajnim punjenjem.', 1300, 22, 18, 'jbl_charge_4.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 20h.', '2024-11-16'),
(628, 'Harman Kardon Onyx Studio 6', 'Zvučnik s elegantnim dizajnom.', 3000, 22, 7, 'harman_kardon_onyx_studio_6.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 8h.', '2024-11-16'),
(629, 'Beats Powerbeats Pro', 'Bežične slušalice za sport.', 2200, 22, 14, 'beats_powerbeats_pro.jpg', 'Bluetooth: Da, Vodootporne: Da, Autonomija: 9h.', '2024-11-16'),
(630, 'Marshall Kilburn II', 'Bežični zvučnik s moćnim zvukom.', 2500, 22, 6, 'marshall_kilburn_ii.jpg', 'Bluetooth: Da, Autonomija: 20h, Vodootporan: Da.', '2024-11-16'),
(631, 'JBL Pulse 4', 'Zvučnik s dinamičkim LED svjetlima.', 2200, 22, 10, 'jbl_pulse_4.jpg', 'Bluetooth: Da, Vodootporan: Da, Autonomija: 12h.', '2024-11-16'),
(632, 'Sony HT-X8500', 'Soundbar s 2.1 kanalnim zvukom.', 2500, 22, 4, 'sony_ht_x8500.jpg', 'Bluetooth: Da, 4K passtrough: Da, Dolby Atmos: Da.', '2024-11-16'),
(633, 'Sennheiser Momentum True Wireless 2', 'Bežične slušalice s odličnim zvukom i ANC.', 1500, 22, 8, 'sennheiser_momentum_true_wireless_2.jpg', 'Bluetooth: Da, Poništavanje buke: Da, Autonomija: 7h.', '2024-11-16'),
(634, 'JBL Reflect Flow', 'Sportske bežične slušalice s visokim performansama.', 1300, 22, 12, 'jbl_reflect_flow.jpg', 'Bluetooth: Da, Vodootporne: Da, Autonomija: 10h.', '2024-11-16'),
(635, 'Intel Core i9-13900K', 'Najnoviji 13. generacije procesor s 24 jezgre za visoke performanse.', 4500, 23, 15, 'intel_i9_13900k.jpg', 'Jezgre: 24, Frekvencija: 3.0 GHz, TDP: 125W.', '2024-11-16'),
(636, 'AMD Ryzen 9 7900X', 'Procesor visoke performanse za gaming i multitasking.', 4200, 23, 20, 'amd_ryzen_9_7900x.jpg', 'Jezgre: 12, Frekvencija: 4.7 GHz, TDP: 170W.', '2024-11-16'),
(637, 'Intel Core i7-13700K', 'Performantni procesor sa 16 jezgri za gaming.', 3200, 23, 18, 'intel_i7_13700k.jpg', 'Jezgre: 16, Frekvencija: 3.4 GHz, TDP: 125W.', '2024-11-16'),
(638, 'AMD Ryzen 7 7700X', 'Procesor sa 8 jezgri i odličnim odnosom cijene i performansi.', 3000, 23, 22, 'amd_ryzen_7_7700x.jpg', 'Jezgre: 8, Frekvencija: 4.5 GHz, TDP: 105W.', '2024-11-16'),  
(639, 'Intel Core i5-13600K', 'Odličan procesor srednje klase s 14 jezgri za gaming.', 2300, 23, 25, 'intel_i5_13600k.jpg', 'Jezgre: 14, Frekvencija: 3.5 GHz, TDP: 125W.', '2024-11-16'),        
(640, 'AMD Ryzen 5 5600X', 'Performantni procesor za gaming i radne stanice.', 2000, 23, 30, 'amd_ryzen_5_5600x.jpg', 'Jezgre: 6, Frekvencija: 3.7 GHz, TDP: 65W.', '2024-11-16'),
(641, 'Intel Core i3-12100F', 'Pristupačan procesor za osnovne računalne zadatke.', 900, 23, 28, 'intel_i3_12100f.jpg', 'Jezgre: 4, Frekvencija: 3.3 GHz, TDP: 58W.', '2024-11-16'),
(642, 'AMD Ryzen 5 7600X', 'Brzi procesor s 6 jezgri za gaming i multitasking.', 2500, 23, 18, 'amd_ryzen_5_7600x.jpg', 'Jezgre: 6, Frekvencija: 4.8 GHz, TDP: 105W.', '2024-11-16'),
(643, 'Intel Core i9-12900K', 'Vrlo moćan procesor sa 16 jezgri i 24 thread-a.', 4300, 23, 10, 'intel_i9_12900k.jpg', 'Jezgre: 16, Frekvencija: 3.2 GHz, TDP: 125W.', '2024-11-16'),
(644, 'AMD Ryzen 9 5900X', 'Procesor sa 12 jezgri za zahtjevne korisnike.', 3900, 23, 13, 'amd_ryzen_9_5900x.jpg', 'Jezgre: 12, Frekvencija: 3.7 GHz, TDP: 105W.', '2024-11-16'),
(645, 'Intel Xeon W-2295', 'Profesionalni procesor za radne stanice s 18 jezgri.', 8000, 23, 6, 'intel_xeon_w_2295.jpg', 'Jezgre: 18, Frekvencija: 3.0 GHz, TDP: 165W.', '2024-11-16'),
(646, 'AMD Threadripper 3990X', 'Ekstremno snažan procesor za radne stanice i servere.', 15000, 23, 2, 'amd_threadripper_3990x.jpg', 'Jezgre: 64, Frekvencija: 2.9 GHz, TDP: 280W.', '2024-11-16'),
(647, 'Intel Core i5-12600K', 'Srednji procesor sa 10 jezgri za gaming i radne stanice.', 2200, 23, 19, 'intel_i5_12600k.jpg', 'Jezgre: 10, Frekvencija: 3.7 GHz, TDP: 125W.', '2024-11-16'),     
(648, 'AMD Ryzen 7 5800X', 'Gaming procesor s 8 jezgri i visokom radnom frekvencijom.', 3200, 23, 12, 'amd_ryzen_7_5800x.jpg', 'Jezgre: 8, Frekvencija: 4.4 GHz, TDP: 105W.', '2024-11-16'),      
(649, 'Intel Core i9-11900K', 'Snažan procesor sa 8 jezgri za gaming i multitasking.', 3500, 23, 7, 'intel_i9_11900k.jpg', 'Jezgre: 8, Frekvencija: 3.5 GHz, TDP: 125W.', '2024-11-16'),
(650, 'AMD Ryzen 5 3400G', 'Pristupačan procesor s integriranim grafičkim čipom.', 1500, 23, 14, 'amd_ryzen_5_3400g.jpg', 'Jezgre: 4, Frekvencija: 3.7 GHz, TDP: 65W.', '2024-11-16'),
(651, 'Intel Core i7-11700K', 'Gaming procesor sa 8 jezgri i 16 thread-a.', 3000, 23, 11, 'intel_i7_11700k.jpg', 'Jezgre: 8, Frekvencija: 3.6 GHz, TDP: 125W.', '2024-11-16'),
(652, 'AMD Ryzen 9 3950X', 'Vrhunski procesor sa 16 jezgri i 32 thread-a.', 6500, 23, 4, 'amd_ryzen_9_3950x.jpg', 'Jezgre: 16, Frekvencija: 3.5 GHz, TDP: 105W.', '2024-11-16'),
(653, 'Intel Core i3-10100F', 'Pristupačan procesor za osnovne aplikacije.', 850, 23, 23, 'intel_i3_10100f.jpg', 'Jezgre: 4, Frekvencija: 3.6 GHz, TDP: 65W.', '2024-11-16'),
(654, 'AMD Ryzen 7 3700X', 'Vrlo dobar procesor za gaming i radne stanice.', 3000, 23, 18, 'amd_ryzen_7_3700x.jpg', 'Jezgre: 8, Frekvencija: 3.6 GHz, TDP: 65W.', '2024-11-16'),
(655, 'Intel Core i5-10400F', 'Srednji procesor za gaming i osnovne aplikacije.', 1500, 23, 24, 'intel_i5_10400f.jpg', 'Jezgre: 6, Frekvencija: 2.9 GHz, TDP: 65W.', '2024-11-16'),
(656, 'AMD Ryzen 9 5950X', 'Izuzetno moćan procesor za radne stanice i gaming.', 7000, 23, 9, 'amd_ryzen_9_5950x.jpg', 'Jezgre: 16, Frekvencija: 3.4 GHz, TDP: 105W.', '2024-11-16'),
(657, 'Intel Core i7-10700K', 'Snažan procesor sa 8 jezgri za gaming.', 2700, 23, 16, 'intel_i7_10700k.jpg', 'Jezgre: 8, Frekvencija: 3.8 GHz, TDP: 125W.', '2024-11-16'),
(658, 'AMD Ryzen 5 2600', 'Pristupačan procesor za gaming i radne stanice.', 1300, 23, 17, 'amd_ryzen_5_2600.jpg', 'Jezgre: 6, Frekvencija: 3.4 GHz, TDP: 95W.', '2024-11-16'),
(659, 'Intel Xeon E-2288G', 'Profesionalni procesor za radne stanice.', 3200, 23, 8, 'intel_xeon_e_2288g.jpg', 'Jezgre: 8, Frekvencija: 3.7 GHz, TDP: 95W.', '2024-11-16'),
(660, 'AMD Ryzen 3 3200G', 'Pristupačan procesor s integriranim grafičkim čipom.', 1000, 23, 30, 'amd_ryzen_3_3200g.jpg', 'Jezgre: 4, Frekvencija: 3.6 GHz, TDP: 65W.', '2024-11-16'),
(661, 'Intel Core i9-11980XE', 'Ekstremni procesor za radne stanice s 18 jezgri.', 10000, 23, 5, 'intel_i9_11980xe.jpg', 'Jezgre: 18, Frekvencija: 3.0 GHz, TDP: 165W.', '2024-11-16'),
(662, 'AMD Ryzen 7 3700X', 'Odličan procesor za gaming i profesionalni rad.', 2800, 23, 18, 'amd_ryzen_7_3700x.jpg', 'Jezgre: 8, Frekvencija: 3.6 GHz, TDP: 65W.', '2024-11-16'),
(663, 'Intel Core i5-10600K', 'Izvrsni procesor za gaming i multimedijalne zadatke.', 1800, 23, 21, 'intel_i5_10600k.jpg', 'Jezgre: 6, Frekvencija: 4.1 GHz, TDP: 125W.', '2024-11-16'),
(664, 'Epson EH-TW7100', '4K projektor s visokom svjetlinom i dinamičnim kontrastom.', 8000, 24, 5, 'epson_eh_tw7100.jpg', 'Rezolucija: 4K, Svjetlina: 2500 lumena, Kontrast: 100000:1.', '2024-11-16'),
(665, 'BenQ TK850i', 'Projektor s 4K HDR i preciznim bojama za kućno kino.', 7500, 24, 7, 'benq_tk850i.jpg', 'Rezolucija: 4K, Svjetlina: 3000 lumena, Kontrast: 3000:1.', '2024-11-16'),
(666, 'Optoma UHD38', 'Projektor visoke svjetline za gaming i filmove.', 6500, 24, 9, 'optoma_uhd38.jpg', 'Rezolucija: 4K, Svjetlina: 4000 lumena, Kontrast: 1,000,000:1.', '2024-11-16'),        
(667, 'ViewSonic PX747-4K', 'Pristupačan 4K projektor za kućno kino.', 4000, 24, 15, 'viewsonic_px747_4k.jpg', 'Rezolucija: 4K, Svjetlina: 3500 lumena, Kontrast: 12000:1.', '2024-11-16'),       
(668, 'LG PF50KS', 'Bežični mini projektor s Full HD rezolucijom.', 2000, 24, 20, 'lg_pf50ks.jpg', 'Rezolucija: 1080p, Svjetlina: 600 lumena, Kontrast: 1000:1.', '2024-11-16'),
(669, 'Epson EF-100', 'Laser projektor s mogućnošću bežičnog povezivanja.', 5500, 24, 11, 'epson_ef100.jpg', 'Rezolucija: Full HD, Svjetlina: 2000 lumena, Kontrast: 250000:1.', '2024-11-16'),   
(670, 'Anker Nebula Capsule', 'Kompaktni projektor s Android operativnim sustavom.', 1500, 24, 25, 'anker_nebula_capsule.jpg', 'Rezolucija: 720p, Svjetlina: 100 ANSI lumena, Kontrast: 1000:1.', '2024-11-16'),
(671, 'XGIMI Horizon Pro', '4K projektor s Android TV platformom i Dolby Atmos zvukom.', 6500, 24, 8, 'xgimi_horizon_pro.jpg', 'Rezolucija: 4K, Svjetlina: 2200 lumena, Kontrast: 12000:1.', '2024-11-16'),
(672, 'Epson Home Cinema 5050UB', 'Projektor za kućno kino s HDR podrškom i 4K.', 8000, 24, 12, 'epson_home_cinema_5050ub.jpg', 'Rezolucija: 4K, Svjetlina: 2600 lumena, Kontrast: 1,000,000:1.', '2024-11-16'),
(673, 'BenQ HT3550', 'Projektor s visokim kontrastom i preciznim bojama.', 4000, 24, 14, 'benq_ht3550.jpg', 'Rezolucija: 4K, Svjetlina: 2000 lumena, Kontrast: 3000:1.', '2024-11-16'),
(674, 'ViewSonic PX706HD', 'Kratkoročni projektor s Full HD rezolucijom i 3000 lumena.', 2800, 24, 22, 'viewsonic_px706hd.jpg', 'Rezolucija: 1080p, Svjetlina: 3000 lumena, Kontrast: 22000:1.', '2024-11-16'),
(675, 'Epson EB-U05', 'Projektor s 3LCD tehnologijom i Full HD rezolucijom.', 2500, 24, 18, 'epson_eb_u05.jpg', 'Rezolucija: Full HD, Svjetlina: 3300 lumena, Kontrast: 15000:1.', '2024-11-16'), 
(676, 'LG HU70LA', '4K projektor s LED tehnologijom za kućno kino.', 6000, 24, 10, 'lg_hu70la.jpg', 'Rezolucija: 4K, Svjetlina: 1500 lumena, Kontrast: 15000:1.', '2024-11-16'),
(677, 'Kodak Luma 350', 'Mini projektor sa 350 lumena i Android sistemom.', 1200, 24, 30, 'kodak_luma_350.jpg', 'Rezolucija: 720p, Svjetlina: 350 lumena, Kontrast: 1000:1.', '2024-11-16'),
(678, 'Epson EB-L630SU', 'Laser projektor visoke svjetline za profesionalne prostorije.', 10000, 24, 3, 'epson_eb_l630su.jpg', 'Rezolucija: WUXGA, Svjetlina: 6000 lumena, Kontrast: 2000000:1.', '2024-11-16'),
(679, 'ViewSonic M1 Mini Plus', 'Mini projektor s bežičnim mogućnostima i Android aplikacijama.', 1500, 24, 16, 'viewsonic_m1_mini_plus.jpg', 'Rezolucija: 720p, Svjetlina: 250 lumena, Kontrast: 1000:1.', '2024-11-16'),
(680, 'Optoma GT1080HDR', 'Projektor s Full HD i HDR podrškom za gaming.', 3000, 24, 13, 'optoma_gt1080hdr.jpg', 'Rezolucija: 1080p, Svjetlina: 3800 lumena, Kontrast: 50000:1.', '2024-11-16'),  
(681, 'Anker Nebula Cosmos Max', 'Projektor s 4K i 3600 lumena svjetline za kućno kino.', 6500, 24, 7, 'anker_nebula_cosmos_max.jpg', 'Rezolucija: 4K, Svjetlina: 3600 lumena, Kontrast: 15000:1.', '2024-11-16'),
(682, 'LG PF50KA', 'Bežični projektor s Full HD i dužim trajanjem baterije.', 2500, 24, 20, 'lg_pf50ka.jpg', 'Rezolucija: Full HD, Svjetlina: 600 lumena, Kontrast: 1000:1.', '2024-11-16'),      
(683, 'Epson EB-X41', 'Projektor s XGA rezolucijom za poslovnu i obrazovnu upotrebu.', 2200, 24, 23, 'epson_eb_x41.jpg', 'Rezolucija: XGA, Svjetlina: 3300 lumena, Kontrast: 15000:1.', '2024-11-16'),
(684, 'XGIMI MoGo Pro+', 'Mini projektor s Android TV i 4K HDR podrškom.', 3500, 24, 9, 'xgimi_mogo_pro.jpg', 'Rezolucija: 1080p, Svjetlina: 300 lumena, Kontrast: 1000:1.', '2024-11-16'),       
(685, 'BenQ GS2', 'Projektor otporan na vodu i prašinu za vanjsku uporabu.', 3000, 24, 18, 'benq_gs2.jpg', 'Rezolucija: 1080p, Svjetlina: 500 lumena, Kontrast: 10000:1.', '2024-11-16'),
(686, 'Optoma UHZ65', 'Laser projektor s 4K rezolucijom i dugovječnošću svjetla.', 12000, 24, 4, 'optoma_uhz65.jpg', 'Rezolucija: 4K, Svjetlina: 3000 lumena, Kontrast: 2000000:1.', '2024-11-16'),
(687, 'Epson LS500', 'Projektor s 4K i laser tehnologijom za kućno kino.', 11000, 24, 2, 'epson_ls500.jpg', 'Rezolucija: 4K, Svjetlina: 4000 lumena, Kontrast: 2000000:1.', '2024-11-16'),        
(688, 'LG CineBeam HU85LA', 'Ultra kratkotrajni projektor s 4K i HDR.', 10000, 24, 3, 'lg_cinebeam_hu85la.jpg', 'Rezolucija: 4K, Svjetlina: 2700 lumena, Kontrast: 15000:1.', '2024-11-16'),      
(689, 'ViewSonic PX748-4K', 'Projektor za kućno kino s 4K rezolucijom.', 7000, 24, 10, 'viewsonic_px748_4k.jpg', 'Rezolucija: 4K, Svjetlina: 3200 lumena, Kontrast: 12000:1.', '2024-11-16'),     
(690, 'Epson EF-100', 'Bežični projektor za kvalitetne filmove na svim površinama.', 5500, 24, 6, 'epson_ef_100.jpg', 'Rezolucija: Full HD, Svjetlina: 2000 lumena, Kontrast: 250000:1.', '2024-11-16'),
(691, 'Razer Kraken V3', 'Gaming slušalice s RGB pozadinskim osvjetljenjem i Dolby Sound.', 1200, 25, 10, 'razer_kraken_v3.jpg', 'Tip: Over-ear, Zvuk: 7.1 surround, Osvjetljenje: RGB.', '2024-11-16'),
(692, 'Logitech G Pro X', 'Gaming slušalice s Blue VO!CE tehnologijom za jasan zvuk.', 1500, 25, 8, 'logitech_g_pro_x.jpg', 'Tip: Over-ear, Zvuk: 7.1 surround, Mikrofoni: Blue VO!CE.', '2024-11-16'),
(693, 'Corsair K95 RGB Platinum', 'Gaming tipkovnica s mehaničkim tipkama i RGB osvjetljenjem.', 2500, 25, 12, 'corsair_k95_rgb_platinum.jpg', 'Tip: Mehanička, Osvjetljenje: RGB, Tipke: Cherry MX.', '2024-11-16'),
(694, 'SteelSeries Rival 600', 'Gaming miš s dvostrukim senzorima za preciznost i brzinu.', 900, 25, 15, 'steelseries_rival_600.jpg', 'Tip: Optički, Senzori: TrueMove3, Osvjetljenje: RGB.', '2024-11-16'),
(695, 'Logitech G923', 'Trkaći volan s TrueForce tehnologijom za bolju povratnu informaciju.', 3500, 25, 5, 'logitech_g923.jpg', 'Tip: Volan, Povratna informacija: TrueForce, Kompatibilnost: PC, PlayStation, Xbox.', '2024-11-16'),
(696, 'Razer Huntsman Elite', 'Gaming tipkovnica s optičkim prekidačima i mehaničkim tipkama.', 2800, 25, 11, 'razer_huntsman_elite.jpg', 'Tip: Optička, Tipke: Razer Linear Optical, Osvjetljenje: RGB.', '2024-11-16'),
(697, 'SteelSeries Arctis 7', 'Bežične gaming slušalice s CrystalClear zvukom i dugotrajnim baterijama.', 1600, 25, 6, 'steelseries_arctis_7.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Baterija: 24h.', '2024-11-16'),
(698, 'Logitech G502 Hero', 'Gaming miš s preciznim senzorom Hero i programabilnim tipkama.', 900, 25, 14, 'logitech_g502_hero.jpg', 'Tip: Optički, Senzor: Hero 16K, Osvjetljenje: RGB.', '2024-11-16'),
(699, 'Corsair Void RGB Elite', 'Bežične gaming slušalice s bogatim zvukom i dugotrajnim udobnostima.', 1400, 25, 9, 'corsair_void_rgb_elite.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Osvjetljenje: RGB.', '2024-11-16'),
(700, 'Razer DeathAdder Elite', 'Gaming miš s ergonomskim dizajnom i preciznim senzorom.', 700, 25, 20, 'razer_deathadder_elite.jpg', 'Tip: Optički, Senzor: 16,000 DPI, Osvjetljenje: RGB.', '2024-11-16'),
(701, 'HyperX Alloy FPS Pro', 'Kompaktna gaming tipkovnica s mehaničkim prekidačima.', 1600, 25, 18, 'hyperx_alloy_fps_pro.jpg', 'Tip: Mehanička, Tipke: Cherry MX, Kompaktna.', '2024-11-16'),   
(702, 'Corsair K70 RGB MK.2', 'Gaming tipkovnica s Cherry MX prekidačima i RGB osvjetljenjem.', 2200, 25, 7, 'corsair_k70_rgb_mk2.jpg', 'Tip: Mehanička, Tipke: Cherry MX, Osvjetljenje: RGB.', '2024-11-16'),
(703, 'Logitech G915 Lightspeed', 'Bežična gaming tipkovnica s ultra tankim dizajnom.', 3500, 25, 5, 'logitech_g915_lightspeed.jpg', 'Tip: Mehanička, Bežična, Osvjetljenje: RGB.', '2024-11-16'),(704, 'Turtle Beach Stealth 600 Gen 2', 'Bežične gaming slušalice za PlayStation s kvalitetnim zvukom.', 1200, 25, 13, 'turtle_beach_stealth_600_gen_2.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Kompatibilnost: PlayStation.', '2024-11-16'),
(705, 'Razer Nari Ultimate', 'Gaming slušalice s haptikom i 7.1 surround zvukom.', 2200, 25, 8, 'razer_nari_ultimate.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Haptika: Razer HyperSense.', '2024-11-16'),
(706, 'SteelSeries Apex Pro', 'Gaming tipkovnica s podesivim mehaničkim prekidačima i RGB osvjetljenjem.', 3500, 25, 4, 'steelseries_apex_pro.jpg', 'Tip: Mehanička, Prekidači: OmniPoint, Osvjetljenje: RGB.', '2024-11-16'),
(707, 'Logitech G930', 'Bežične gaming slušalice s 7.1 surround zvukom i dugotrajnim baterijama.', 1800, 25, 12, 'logitech_g930.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Baterija: 12h.', '2024-11-16'),
(708, 'Corsair Scimitar RGB Elite', 'Gaming miš s 17 programabilnih tipki za MMO igre.', 1400, 25, 10, 'corsair_scimitar_rgb_elite.jpg', 'Tip: Optički, Tipke: 17, Osvjetljenje: RGB.', '2024-11-16'),
(709, 'SteelSeries Rival 310', 'Gaming miš s ergonomskim dizajnom i visokim DPI senzorom.', 1000, 25, 14, 'steelseries_rival_310.jpg', 'Tip: Optički, Senzor: TrueMove3, DPI: 12000.', '2024-11-16'),
(710, 'Razer BlackWidow V3', 'Mehanička gaming tipkovnica s Razer Green prekidačima.', 2200, 25, 11, 'razer_blackwidow_v3.jpg', 'Tip: Mehanička, Tipke: Razer Green, Osvjetljenje: RGB.', '2024-11-16'),
(711, 'Logitech G413', 'Mehanička gaming tipkovnica s Romer-G prekidačima i čvrstim aluminijskim okvirom.', 1600, 25, 15, 'logitech_g413.jpg', 'Tip: Mehanička, Prekidači: Romer-G, Osvjetljenje: Bijelo.', '2024-11-16'),
(712, 'Tritton Kunai 7.1', 'Gaming slušalice s 7.1 surround zvukom i mogućnostima prilagodbe.', 1300, 25, 9, 'tritton_kunai_71.jpg', 'Tip: Bežične, Zvuk: 7.1 surround, Kompatibilnost: PC, PlayStation, Xbox.', '2024-11-16'),
(713, 'Corsair Harpoon RGB Wireless', 'Bežični gaming miš s 6 programabilnih tipki i RGB osvjetljenjem.', 800, 25, 17, 'corsair_harpoon_rgb_wireless.jpg', 'Tip: Bežični, Osvjetljenje: RGB, Tipke: 6.', '2024-11-16'),
(714, 'Razer Mamba Elite', 'Gaming miš s ergonomskim dizajnom i visokim performansama.', 1200, 25, 10, 'razer_mamba_elite.jpg', 'Tip: Optički, DPI: 16,000, Osvjetljenje: RGB.', '2024-11-16'),   
(715, 'SteelSeries Apex 7', 'Mehanička gaming tipkovnica s RGB i dugovječnošću.', 2500, 25, 8, 'steelseries_apex_7.jpg', 'Tip: Mehanička, Prekidači: SteelSeries, Osvjetljenje: RGB.', '2024-11-16'),
(716, 'Turtle Beach Recon 200', 'Gaming slušalice s pojačalom i poboljšanim basovima.', 900, 25, 18, 'turtle_beach_recon_200.jpg', 'Tip: On-ear, Zvuk: 40mm, Kompatibilnost: PC, PlayStation, Xbox.', '2024-11-16'),
(717, 'Oculus Quest 2', 'Samostalni VR uređaj s visokokvalitetnim ekranom i bez računala.', 3000, 26, 15, 'oculus_quest_2.jpg', 'Rezolucija: 1832x1920 po oku, 6DoF, Bežični.', '2024-11-16'),    
(718, 'HTC Vive Pro 2', 'VR headset za profesionalnu upotrebu s 5K rezolucijom.', 6000, 26, 8, 'htc_vive_pro_2.jpg', 'Rezolucija: 2448x2448 po oku, 120Hz, 5K.', '2024-11-16'),
(719, 'PlayStation VR2', 'Virtualna stvarnost za PlayStation 5 s naprednim funkcijama.', 4500, 26, 10, 'playstation_vr2.jpg', 'Rezolucija: 2000x2040 po oku, Kompatibilnost: PS5.', '2024-11-16'),(720, 'Valve Index', 'Visoko kvalitetni VR headset s širokim vidnim poljem.', 7500, 26, 5, 'valve_index.jpg', 'Rezolucija: 1440x1600 po oku, 120Hz, 130° FOV.', '2024-11-16'),
(721, 'Oculus Rift S', 'VR uređaj s prilagodljivim strapovima za bolju udobnost.', 2500, 26, 12, 'oculus_rift_s.jpg', 'Rezolucija: 1280x1440 po oku, 80Hz, Kompatibilnost: PC.', '2024-11-16'),   
(722, 'Pico Neo 3', 'Bežični VR headset za visoke performanse i dugotrajno igranje.', 3500, 26, 6, 'pico_neo_3.jpg', 'Rezolucija: 3664x1920, 90Hz, 6DoF.', '2024-11-16'),
(723, 'HP Reverb G2', 'Visoko rezolucijski VR headset za simulacije i profesionalnu upotrebu.', 8000, 26, 4, 'hp_reverb_g2.jpg', 'Rezolucija: 2160x2160 po oku, 90Hz, 114° FOV.', '2024-11-16'),  
(724, 'Lenovo Mirage Solo', 'Autonomni VR uređaj za jednostavnu upotrebu i pristupačnost.', 2000, 26, 18, 'lenovo_mirage_solo.jpg', 'Rezolucija: 2560x1440, 75Hz, Kompatibilnost: Bežično.', '2024-11-16'),
(725, 'Samsung Odyssey+', 'AMOLED VR headset s visokom razlučivošću za intenzivne igre.', 4000, 26, 9, 'samsung_odyssey_plus.jpg', 'Rezolucija: 2880x1600, 90Hz, AMOLED.', '2024-11-16'),
(726, 'Vive Cosmos Elite', 'VR headset s preciznim praćenjem i ugrađenim slušalicama.', 5500, 26, 7, 'vive_cosmos_elite.jpg', 'Rezolucija: 2880x1700 po oku, 90Hz, Kompatibilnost: PC.', '2024-11-16'),
(727, 'Oculus Link Cable', 'USB-C kabel za povezivanje Oculus Quest s računalom.', 300, 26, 20, 'oculus_link_cable.jpg', 'Dužina: 5m, Kompatibilnost: Oculus Quest, PC.', '2024-11-16'),
(728, 'Oculus Touch Kontroleri', 'Ergonomski VR kontroleri za precizno upravljanje igrama.', 1000, 26, 15, 'oculus_touch_kontroleri.jpg', 'Tip: Bežični, Kompatibilnost: Oculus Quest.', '2024-11-16'),
(729, 'Vive Trackers', 'Praćenje pokreta za dodatnu preciznost u VR iskustvima.', 1200, 26, 5, 'vive_trackers.jpg', 'Kompatibilnost: HTC Vive, Komplet: 3 trackers.', '2024-11-16'),
(730, 'PSVR Aim Controller', 'Specijalizirani kontroler za VR igre s preciznim ciljanjem.', 900, 26, 11, 'psvr_aim_controller.jpg', 'Kompatibilnost: PlayStation VR, Bežični.', '2024-11-16'),    
(731, 'Vive Pro Audio Strap', 'Slušalice i headset s poboljšanom udobnošću za HTC Vive Pro.', 1800, 26, 8, 'vive_pro_audio_strap.jpg', 'Kompatibilnost: HTC Vive Pro, Podesiv, Integrirani zvuk.', '2024-11-16'),
(732, 'Oculus Quest 2 Elite Strap', 'Podesiv remen za veću udobnost tijekom VR iskustava.', 600, 26, 16, 'oculus_quest_2_elite_strap.jpg', 'Kompatibilnost: Oculus Quest 2, Podesivo, Udobno.', '2024-11-16'),
(733, 'Oculus Quest 2 Fit Pack', 'Dodatna oprema za bolju udobnost i podešavanje Oculus Quest 2.', 400, 26, 12, 'oculus_quest_2_fit_pack.jpg', 'Kompatibilnost: Oculus Quest 2, Udobnost: Silikonski poklopci.', '2024-11-16'),
(734, 'Pico Neo 2 Eye', 'VR headset s prilagođenim praćenjem očiju za vrhunske performanse.', 6500, 26, 6, 'pico_neo_2_eye.jpg', 'Rezolucija: 3664x1920, 90Hz, Eye-tracking.', '2024-11-16'),
(735, 'HTC Vive Wireless Adapter', 'Bežični adapter za HTC Vive kako bi se eliminirali kablovi.', 2500, 26, 7, 'htc_vive_wireless_adapter.jpg', 'Kompatibilnost: HTC Vive, Bežični.', '2024-11-16'),
(736, 'Oculus Rift S Carrying Case', 'Zaštitna torba za Oculus Rift S VR headset.', 400, 26, 15, 'oculus_rift_s_carrying_case.jpg', 'Kompatibilnost: Oculus Rift S, Materijal: EVA.', '2024-11-16'),
(737, 'The Witcher 3: Wild Hunt', 'Akcijska RPG igra smještena u fantastičnom svijetu.', 350, 28, 25, 'the_witcher_3.jpg', 'Žanr: RPG, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(738, 'Red Dead Redemption 2', 'Pustolovna igra smještena u Divlji zapad.', 450, 28, 30, 'red_dead_redemption_2.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(739, 'Cyberpunk 2077', 'Sci-fi RPG u futurističkom okruženju.', 400, 28, 20, 'cyberpunk_2077.jpg', 'Žanr: RPG, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),
(740, 'Minecraft', 'Popularna sandbox igra za gradnju i preživljavanje.', 250, 28, 40, 'minecraft.jpg', 'Žanr: Sandbox, Platforme: PC, PS4, Xbox, Switch.', '2024-11-16'),
(741, 'GTA V', 'Akcijska avantura smještena u otvorenom svijetu.', 350, 28, 35, 'gta_v.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(742, 'FIFA 23', 'Najnoviji nastavak popularnog nogometnog serijala.', 300, 28, 50, 'fifa_23.jpg', 'Žanr: Sportska simulacija, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),
(743, 'Call of Duty: Modern Warfare II', 'Akcijska pucačina iz prvog lica.', 400, 28, 20, 'call_of_duty_mw2.jpg', 'Žanr: FPS, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(744, 'The Elder Scrolls V: Skyrim', 'RPG igra u otvorenom svijetu s bogatom pričom.', 350, 28, 15, 'skyrim.jpg', 'Žanr: RPG, Platforme: PC, PS4, Xbox, Switch.', '2024-11-16'),
(745, "Assassin's Creed Valhalla", 'Akcijska avantura smještena u vikinško doba.', 500, 28, 22, 'assassins_creed_valhalla.jpg', 'Žanr: Akcija, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),(746, 'Horizon Zero Dawn', 'Akcijska avantura smještena u post-apokaliptični svijet.', 450, 28, 18, 'horizon_zero_dawn.jpg', 'Žanr: Akcija, Platforme: PS4, PC.', '2024-11-16'),
(747, 'Battlefield 2042', 'Pucačina s futurističkim ratovima i velikim bojištima.', 400, 28, 28, 'battlefield_2042.jpg', 'Žanr: FPS, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),
(748, "Sid Meier's Civilization VI", 'Strategijska igra u kojoj igrač vodi svoju civilizaciju do svjetske dominacije.', 350, 28, 25, 'civilization_vi.jpg', 'Žanr: Strategija, Platforme: PC, Switch, PS4, Xbox.', '2024-11-16'),
(749, 'The Legend of Zelda: Breath of the Wild', 'Akcijska avantura u otvorenom svijetu s puzzle elementima.', 500, 28, 30, 'zelda_breath_of_the_wild.jpg', 'Žanr: Akcija, Platforme: Switch.', '2024-11-16'),
(750, 'Monster Hunter: World', 'Akcijska igra u kojoj igrač lovi ogromne zvijeri.', 400, 28, 25, 'monster_hunter_world.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(751, 'Among Us', 'Popularna multiplayer društvena igra u kojoj se mora otkriti tko je imposter.', 150, 28, 50, 'among_us.jpg', 'Žanr: Party, Platforme: PC, Switch, Mobile.', '2024-11-16'),     
(752, 'Watch Dogs: Legion', 'Akcijska avantura u kojoj se igrač bori protiv korupcije u Londonu.', 400, 28, 19, 'watch_dogs_legion.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),(753, 'The Sims 4', 'Simulacijska igra u kojoj igrač kontrolira virtualne likove.', 300, 28, 35, 'the_sims_4.jpg', 'Žanr: Simulacija, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(754, 'Red Dead Redemption', 'Prequel RDR2 smješten u Divlji zapad.', 350, 28, 30, 'red_dead_redemption.jpg', 'Žanr: Akcija, Platforme: PS3, Xbox 360.', '2024-11-16'),
(755, 'Tomb Raider', 'Akcijska avantura u kojoj igrač preživljava opasne situacije kao Lara Croft.', 350, 28, 18, 'tomb_raider.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),    
(756, 'Minecraft Dungeons', 'Akcijska avantura u Minecraft svijetu.', 250, 28, 20, 'minecraft_dungeons.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox, Switch.', '2024-11-16'),
(757, 'F1 2023', 'Simulacija Formule 1 s realističnim prikazom utrka.', 450, 28, 22, 'f1_2023.jpg', 'Žanr: Sportska simulacija, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),
(758, 'Far Cry 6', 'Akcijska avantura smještena u fikcionalnu tropsku zemlju.', 400, 28, 19, 'far_cry_6.jpg', 'Žanr: Akcija, Platforme: PC, PS5, Xbox Series X.', '2024-11-16'),
(759, 'Spiderman: Miles Morales', 'Akcijska avantura u kojoj igrač preuzima ulogu Spider-Mana Milesa Moralesa.', 450, 28, 25, 'spiderman_miles_morales.jpg', 'Žanr: Akcija, Platforme: PS5, PS4.', '2024-11-16'),
(760, 'Sekiro: Shadows Die Twice', 'Akcijska avantura u kojoj igrač istražuje Japan u feudalnom razdoblju.', 500, 28, 23, 'sekiro_shadows_die_twice.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(761, 'Star Wars Jedi: Fallen Order', 'Akcijska avantura smještena u Star Wars svemir.', 400, 28, 30, 'star_wars_jedi_fallen_order.jpg', 'Žanr: Akcija, Platforme: PC, PS4, Xbox.', '2024-11-16'),(762, 'Need for Speed Heat', 'Racing igra s naglaskom na ulicu i ilegalne utrke.', 350, 28, 30, 'need_for_speed_heat.jpg', 'Žanr: Racing, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(763, 'Borderlands 3', 'Kooperativna pucačina u otvorenom svijetu s RPG elementima.', 400, 28, 28, 'borderlands_3.jpg', 'Žanr: FPS, Platforme: PC, PS4, Xbox.', '2024-11-16'),
(764, 'Dead by Daylight', 'Asimetrična horor multiplayer igra u kojoj jedan igrač lovi ostale.', 250, 28, 35, 'dead_by_daylight.jpg', 'Žanr: Horor, Platforme: PC, PS4, Xbox.', '2024-11-16'),    
(765, 'Apple Watch Series 8', 'Pametan sat s funkcijama praćenja zdravlja i fitnessa.', 3000, 29, 15, 'apple_watch_series_8.jpg', 'Zaslon: Retina, OS: watchOS, Baterija: do 18 sati.', '2024-11-16'),
(766, 'Samsung Galaxy Watch 6', 'Pametan sat sa senzorima za praćenje fitnessa i zdravlja.', 2500, 29, 20, 'samsung_galaxy_watch_6.jpg', 'Zaslon: Super AMOLED, OS: WearOS, Baterija: do 40 sati.', '2024-11-16'),
(767, 'Garmin Venu 2', 'Pametan sat za sportaše sa senzorima za praćenje aktivnosti.', 2000, 29, 18, 'garmin_venu_2.jpg', 'Zaslon: AMOLED, OS: Garmin OS, Baterija: do 11 dana.', '2024-11-16'),  
(768, 'Fitbit Sense 2', 'Pametan sat s funkcijama za praćenje zdravlja i stresa.', 1500, 29, 22, 'fitbit_sense_2.jpg', 'Zaslon: AMOLED, OS: Fitbit OS, Baterija: do 6 dana.', '2024-11-16'),      
(769, 'Amazfit GTR 4', 'Pametan sat s dugim trajanjem baterije i senzorima za zdravlje.', 1800, 29, 25, 'amazfit_gtr_4.jpg', 'Zaslon: AMOLED, OS: Zepp OS, Baterija: do 14 dana.', '2024-11-16'), 
(770, 'Huawei Watch GT 3', 'Pametan sat s funkcijama za praćenje fitnessa i zdravlja.', 2000, 29, 20, 'huawei_watch_gt_3.jpg', 'Zaslon: AMOLED, OS: HarmonyOS, Baterija: do 14 dana.', '2024-11-16'),
(771, 'Withings Steel HR Sport', 'Pametan sat s klasičnim izgledom i funkcijama za praćenje aktivnosti.', 1500, 29, 30, 'withings_steel_hr_sport.jpg', 'Zaslon: OLED, OS: Withings OS, Baterija: do 25 dana.', '2024-11-16'),
(772, 'Polar Vantage V2', 'Pametan sat za sportaše sa naprednim funkcijama za praćenje performansi.', 3500, 29, 18, 'polar_vantage_v2.jpg', 'Zaslon: MIP, OS: Polar OS, Baterija: do 7 dana.', '2024-11-16'),
(773, 'Suunto 9 Peak', 'Pametan sat za sportaše s preciznim senzorima za praćenje aktivnosti.', 4000, 29, 15, 'suunto_9_peak.jpg', 'Zaslon: AMOLED, OS: Suunto OS, Baterija: do 25 sati.', '2024-11-16'),
(774, 'TicWatch Pro 3', 'Pametan sat s dualnim zaslonom i dugotrajnim trajanjem baterije.', 2300, 29, 25, 'ticwatch_pro_3.jpg', 'Zaslon: AMOLED, OS: WearOS, Baterija: do 72 sata.', '2024-11-16'),
(775, 'Creality Ender 3 V2', 'Popularni 3D pisač s velikim volumenom printanja.', 2200, 30, 25, 'creality_ender_3_v2.jpg', 'Tip: FDM, Volumen: 220x220x250 mm, Brzina: 180mm/s.', '2024-11-16'),  
(776, 'Prusa i3 MK3S+', 'Visokokvalitetni 3D pisač s naprednim funkcijama.', 8000, 30, 15, 'prusa_i3_mk3s.jpg', 'Tip: FDM, Volumen: 250x210x210 mm, Brzina: 200mm/s.', '2024-11-16'),
(777, 'Anycubic Vyper', 'Brzi i precizni 3D pisač s automatskim niveliranjem.', 2500, 30, 20, 'anycubic_vyper.jpg', 'Tip: FDM, Volumen: 245x245x260 mm, Brzina: 100mm/s.', '2024-11-16'),
(778, 'Artillery Sidewinder X1', 'Pisač s velikim volumenom printanja i naprednim značajkama.', 3500, 30, 30, 'artillery_sidewinder_x1.jpg', 'Tip: FDM, Volumen: 300x300x400 mm, Brzina: 150mm/s.', '2024-11-16'),
(779, 'Elegoo Mars 2 Pro', 'Stereolitografski 3D pisač za preciznu proizvodnju.', 2500, 30, 25, 'elegoo_mars_2_pro.jpg', 'Tip: SLA, Volumen: 129x80x160 mm, Brzina: 50mm/h.', '2024-11-16'),      
(780, 'Anycubic Photon Mono X', 'UV resin printer za visoku preciznost 3D ispisa.', 3000, 30, 20, 'anycubic_photon_mono_x.jpg', 'Tip: SLA, Volumen: 192x120x245 mm, Brzina: 60mm/h.', '2024-11-16'),
(781, 'Bambulab X1', 'Visoko precizni 3D pisač za profesionalne korisnike.', 9000, 30, 15, 'bambulab_x1.jpg', 'Tip: FDM, Volumen: 256x256x256 mm, Brzina: 180mm/s.', '2024-11-16'),
(782, 'Elegoo Neptune 2S', 'Pisač sa stabilnim performansama i povoljnim cijenama.', 1800, 30, 30, 'elegoo_neptune_2s.jpg', 'Tip: FDM, Volumen: 220x220x250 mm, Brzina: 150mm/s.', '2024-11-16'), 
(783, 'FlashForge Adventurer 3', 'Kompaktni 3D pisač s automatskim niveliranjem i Wi-Fi povezivanjem.', 4000, 30, 20, 'flashforge_adventurer_3.jpg', 'Tip: FDM, Volumen: 150x150x150 mm, Brzina: 100mm/s.', '2024-11-16'),
(784, 'Raise3D Pro2', 'Visokokvalitetni 3D pisač za profesionalce i industrijske primjene.', 15000, 30, 10, 'raise3d_pro2.jpg', 'Tip: FDM, Volumen: 305x305x300 mm, Brzina: 150mm/s.', '2024-11-16'),
(785, 'Voxelab Aquila X2', 'Odličan 3D pisač za početnike s velikim volumenom printanja.', 2200, 30, 28, 'voxelab_aquila_x2.jpg', 'Tip: FDM, Volumen: 220x220x250 mm, Brzina: 180mm/s.', '2024-11-16'),
(786, 'Creality CR-10', 'Popularni pisač za DIY projekte s velikim volumenom printanja.', 3500, 30, 25, 'creality_cr_10.jpg', 'Tip: FDM, Volumen: 300x300x400 mm, Brzina: 150mm/s.', '2024-11-16'),
(787, 'Snapmaker 2.0 A350', 'Svestrani 3D pisač koji podržava i lasersko graviranje.', 8500, 30, 18, 'snapmaker_2.0_a350.jpg', 'Tip: FDM, Volumen: 320x350x330 mm, Brzina: 200mm/s.', '2024-11-16'),
(788, 'FDM-Tek', 'Pisač s naprednim funkcijama za preciznu proizvodnju.', 7000, 30, 12, 'fdm_tek.jpg', 'Tip: FDM, Volumen: 250x250x250 mm, Brzina: 180mm/s.', '2024-11-16'),
(789, 'Prusa Mini+', 'Kompatibilni 3D pisač s odličnim performansama i jednostavnim postavljanjem.', 4500, 30, 30, 'prusa_mini_plus.jpg', 'Tip: FDM, Volumen: 180x180x180 mm, Brzina: 200mm/s.', '2024-11-16'),
(790, 'Polaroid PlaySmart', 'Jednostavan 3D pisač za kućnu upotrebu.', 1500, 30, 25, 'polaroid_playsmart.jpg', 'Tip: FDM, Volumen: 110x110x120 mm, Brzina: 90mm/s.', '2024-11-16'),
(791, 'Monoprice Voxel', 'Kompaktni 3D pisač s jednostavnom instalacijom i upotrebom.', 2200, 30, 27, 'monoprice_voxel.jpg', 'Tip: FDM, Volumen: 120x120x120 mm, Brzina: 100mm/s.', '2024-11-16'),(792, 'LulzBot Mini 2', 'Pisač za napredne korisnike s visokom preciznošću.', 6000, 30, 20, 'lulzbot_mini_2.jpg', 'Tip: FDM, Volumen: 160x160x180 mm, Brzina: 150mm/s.', '2024-11-16'),
(793, 'Zortrax M200 Plus', 'Visokokvalitetni 3D pisač za profesionalne primjene.', 10000, 30, 18, 'zortrax_m200_plus.jpg', 'Tip: FDM, Volumen: 200x200x200 mm, Brzina: 150mm/s.', '2024-11-16'),  
(794, 'Anycubic Chiron', 'Pisač s velikim volumenom printanja i visokim kvalitetom.', 3500, 30, 25, 'anycubic_chiron.jpg', 'Tip: FDM, Volumen: 400x400x450 mm, Brzina: 180mm/s.', '2024-11-16'),  
(795, 'Kossel Delta', 'Delta 3D pisač s visokom preciznošću.', 3000, 30, 20, 'kossel_delta.jpg', 'Tip: Delta, Volumen: 230x230x300 mm, Brzina: 180mm/s.', '2024-11-16'),
(796, 'BCN3D Sigma D25', 'Profesionalni 3D pisač za industrijsku proizvodnju.', 11000, 30, 15, 'bcn3d_sigma_d25.jpg', 'Tip: FDM, Volumen: 420x300x210 mm, Brzina: 200mm/s.', '2024-11-16'),       
(797, 'Flsun Q5', 'Delta 3D pisač s velikim volumenom i brzim ispisom.', 3500, 30, 20, 'flsun_q5.jpg', 'Tip: Delta, Volumen: 260x260x330 mm, Brzina: 180mm/s.', '2024-11-16'),
(798, 'Tevo Tornado', 'Ekonomičan 3D pisač za kućnu proizvodnju.', 2500, 30, 25, 'tevo_tornado.jpg', 'Tip: FDM, Volumen: 300x300x400 mm, Brzina: 150mm/s.', '2024-11-16'),
(799, 'USB-C to USB-A kabel', 'Kabel za prijenos podataka i punjenje s USB-C na USB-A konektorom.', 100, 27, 50, 'usb_c_to_usb_a.jpg', 'Dužina: 1m, Brzina prijenosa: 5Gbps, Podrška za brzo punjenje.', '2024-11-16'),
(800, 'HDMI kabel', 'Standardni HDMI kabel za prijenos video i audio signala.', 150, 27, 40, 'hdmi_kabel.jpg', 'Dužina: 2m, Verzija: 2.0, Podrška za 4K.', '2024-11-16'),
(801, 'Ethernet kabel (Cat 6)', 'Kabel za brzi internet s brzinom do 10 Gbps.', 120, 27, 30, 'ethernet_cat6.jpg', 'Dužina: 3m, Kategorija: Cat 6, Brzina: do 10 Gbps.', '2024-11-16'),
(802, 'VGA to HDMI adapter', 'Adapter za pretvorbu VGA signala u HDMI.', 250, 27, 25, 'vga_to_hdmi_adapter.jpg', 'Podrška za 1080p, Kompatibilno s računalima i TV uređajima.', '2024-11-16'),    
(803, 'USB-C to Lightning kabel', 'Kabel za brzo punjenje Apple uređaja s USB-C na Lightning konektorom.', 180, 27, 60, 'usb_c_to_lightning.jpg', 'Dužina: 1m, Brzina prijenosa: 20Gbps, Kompatibilno s iPhone uređajima.', '2024-11-16'),
(804, 'DisplayPort to HDMI kabel', 'Kabel za prijenos slike i zvuka s DisplayPort na HDMI.', 200, 27, 50, 'displayport_to_hdmi.jpg', 'Dužina: 2m, Verzija: 1.2, Podrška za 4K.', '2024-11-16'),   
(805, 'USB 3.0 hub', 'USB hub za proširenje USB portova s 4 porta.', 350, 27, 45, 'usb_3_0_hub.jpg', 'Portovi: 4x USB 3.0, Brzina prijenosa: do 5Gbps.', '2024-11-16'),
(806, 'Mini DisplayPort to HDMI', 'Adapter za pretvorbu Mini DisplayPort signala u HDMI.', 180, 27, 30, 'mini_displayport_to_hdmi.jpg', 'Podrška za 1080p, Kompatibilno s računalima i projektorima.', '2024-11-16'),
(807, 'MHL to HDMI kabel', 'Kabel za povezivanje mobilnih uređaja s HDMI televizorom.', 200, 27, 20, 'mhl_to_hdmi.jpg', 'Dužina: 1.5m, Kompatibilno s većinom Android uređaja.', '2024-11-16'),   
(808, '3.5mm audio kabel', 'Kabel za prijenos audio signala s 3.5mm jack konektorom.', 80, 27, 60, 'audio_3_5mm_kabel.jpg', 'Dužina: 1.2m, Materijal: PVC, Podrška za stereo zvuk.', '2024-11-16'),
(809, 'USB to Ethernet adapter', 'Adapter za povezivanje računala s mrežom putem Ethernet kabela.', 250, 27, 40, 'usb_to_ethernet_adapter.jpg', 'Brzina: 1000Mbps, Kompatibilno s Windows i MacOS.', '2024-11-16'),
(810, 'USB-C to HDMI adapter', 'Adapter za povezivanje uređaja s USB-C portom na HDMI ekran.', 200, 27, 50, 'usb_c_to_hdmi_adapter.jpg', 'Podrška za 4K, Kompatibilno s prijenosnim računalima i telefonima.', '2024-11-16'),
(811, 'USB 3.0 to Gigabit Ethernet adapter', 'Adapter za povezivanje uređaja s Gigabit Ethernet mrežom.', 300, 27, 30, 'usb_3_0_to_ethernet_adapter.jpg', 'Brzina prijenosa: do 1000Mbps, Kompatibilno s Windows, Mac i Linux.', '2024-11-16'),
(812, '3.5mm to RCA audio kabel', 'Audio kabel za povezivanje uređaja s 3.5mm izlazom i RCA ulazima.', 90, 27, 40, 'audio_3_5mm_to_rca.jpg', 'Dužina: 2m, Materijal: PVC, Stereo prijenos zvuka.', '2024-11-16'),
(813, 'USB to USB-C kabel', 'Kabel za prijenos podataka i punjenje s USB na USB-C konektorom.', 120, 27, 50, 'usb_to_usb_c_kabel.jpg', 'Dužina: 1m, Brzina prijenosa: 5Gbps, Kompatibilno s novim uređajima.', '2024-11-16'),
(814, 'Lightning to 3.5mm adapter', 'Adapter za povezivanje slušalica s 3.5mm jackom na Apple uređaje s Lightning portom.', 100, 27, 55, 'lightning_to_3_5mm_adapter.jpg', 'Podrška za stereo zvuk, Kompatibilno s iPhone i iPad uređajima.', '2024-11-16'),
(815, 'USB-C to VGA adapter', 'Adapter za povezivanje uređaja s USB-C portom na VGA ekran.', 220, 27, 25, 'usb_c_to_vga_adapter.jpg', 'Podrška za 1080p, Kompatibilno s projektorima i starijim računalima.', '2024-11-16'),
(816, 'Powerline Ethernet adapter', 'Adapter za povezivanje preko postojeće električne mreže za brzi internet.', 450, 27, 15, 'powerline_ethernet_adapter.jpg', 'Brzina prijenosa: do 1000Mbps, Podrška za mreže do 300m.', '2024-11-16'),
(817, 'USB-C to microUSB kabel', 'Kabel za prijenos podataka i punjenje s USB-C na microUSB konektorom.', 100, 27, 60, 'usb_c_to_microusb.jpg', 'Dužina: 1m, Brzina prijenosa: 5Gbps, Kompatibilno s Android uređajima.', '2024-11-16'),
(818, 'DisplayPort to DisplayPort kabel', 'Kabel za prijenos video signala između dva DisplayPort uređaja.', 250, 27, 45, 'displayport_to_displayport.jpg', 'Dužina: 1.5m, Verzija: 1.2, Podrška za 4K.', '2024-11-16'),
(819, 'DVI to HDMI kabel', 'Kabel za prijenos video signala s DVI na HDMI.', 150, 27, 50, 'dvi_to_hdmi_kabel.jpg', 'Dužina: 2m, Kompatibilno s računalima i TV uređajima.', '2024-11-16'),        
(820, 'USB-C to DisplayPort kabel', 'Kabel za prijenos video signala s USB-C na DisplayPort.', 220, 27, 30, 'usb_c_to_displayport.jpg', 'Dužina: 2m, Podrška za 4K, Kompatibilno s većinom laptopa i računala.', '2024-11-16'),
(821, 'MicroSD to USB adapter', 'Adapter za prijenos podataka između MicroSD kartica i računala.', 100, 27, 55, 'microsd_to_usb_adapter.jpg', 'Podrška za MicroSD kartice, Kompatibilno s USB 2.0 i 3.0.', '2024-11-16'),
(822, 'USB to HDMI adapter', 'Adapter za povezivanje računala s HDMI ekranom putem USB porta.', 280, 27, 20, 'usb_to_hdmi_adapter.jpg', 'Podrška za 1080p, Kompatibilno s Windows i MacOS.', '2024-11-16'),
(823, 'RJ45 coupler', 'Spojka za povezivanje dvaju Ethernet kablova.', 40, 27, 70, 'rj45_coupler.jpg', 'Podrška za Cat 5, 6 i 7 Ethernet kablove.', '2024-11-16'),
(824, 'Mini HDMI to HDMI kabel', 'Kabel za prijenos video i audio signala s Mini HDMI na standardni HDMI.', 180, 27, 50, 'mini_hdmi_to_hdmi_kabel.jpg', 'Dužina: 1.5m, Podrška za 1080p, Kompatibilno s prijenosnim računalima i kamerama.', '2024-11-16'),
(825, 'Type-C to Type-C kabel', 'Kabel za prijenos podataka i punjenje s USB-C na USB-C konektorom.', 150, 27, 50, 'type_c_to_type_c.jpg', 'Dužina: 1m, Brzina prijenosa: 10Gbps, Podrška za brzo punjenje.', '2024-11-16');
